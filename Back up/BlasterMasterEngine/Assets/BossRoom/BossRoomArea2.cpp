...
#include "Assets/Item/BreakWallBulletItem/BreakWallBulletItem.h"
...
{
	spriteRenderer->sprite = DeviceResources::LoadTexture(AREA2_BOSSROOM_PATH, 0);
	KeyFrame keyFrame;
	RECT rect = { 0,0,0,0 };
...
#pragma endregion
	...
	// background object resource
	{
		...
		backgroundObj->spriteRenderer->sprite = DeviceResources::LoadTexture(AREA2_BOSSROOM_PATH, 0);
